...
Route::get('/api/pricing/next-uid', [FrontendController::class, 'pricingNextUid']);
Route::post('/api/pricing/lead', [FrontendController::class, 'savePricingLead']);
Route::post('/api/pricing/create-order', [FrontendController::class, 'createPricingRazorpayOrder']);
Route::post('/api/pricing/convert', [FrontendController::class, 'convertPricingLead']);
