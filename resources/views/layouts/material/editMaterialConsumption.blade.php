                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <div class="form-group">
                                                    <label>Site</label>
                                                    @if ($has_locked_site)
                                                        <input type="hidden" name="site_id" id="site_id" value="{{ $consumption->site_id }}">
                                                        <input type="text" class="form-control" value="{{ getSiteDetailsById($consumption->site_id)->name }}" readonly>
                                                    @else
